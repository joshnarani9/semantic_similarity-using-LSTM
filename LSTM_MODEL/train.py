...
import pandas as pd ##importing package pandas to read dataset
...
##importing packages required for model building
...
#to train model and to obtain model weights ,trained on questions dataset of kaggle
#can obtain from https://www.kaggle.com/c/quora-question-pairs/data which is train.csv
# File paths
...
# LSTM
x.add(LSTM(n_hidden))
##As this is a siamese network both sides sharing lstm
shared_model = x
